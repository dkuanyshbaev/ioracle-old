    ...
    pub fn render_first(&self, settings: &Binding, controller: &mut Controller) {
        match self {
            ...
            Trigram {
                ...
                render_yin(2, controller, &settings.cloud_colour);
            }
            // Sun
            Trigram {
                top: Line::Yang,
                ...
                render_yin(1, controller, &settings.sun_colour);
                render_yang(2, controller, &settings.sun_colour);
            }
            // Wind
            Trigram {
                top: Line::Yang,
                ...
                render_yin(6, controller, &settings.wind_colour);
                render_yang(1, controller, &settings.wind_colour);
                render_yang(2, controller, &settings.wind_colour);
            }
            // Thunder
            Trigram {
                top: Line::Yin,
                ...
                render_yang(6, controller, &settings.thunder_colour);
                render_yin(1, controller, &settings.thunder_colour);
                render_yin(2, controller, &settings.thunder_colour);
            }
            // Water
            Trigram {
                top: Line::Yin,
                ...
                render_yang(1, controller, &settings.water_colour);
                render_yin(2, controller, &settings.water_colour);
            }
            // Mountain
            Trigram {
                top: Line::Yang,
                ...
                render_yang(2, controller, &settings.mountain_colour);
            }
            // Earth
            Trigram {
                top: Line::Yin,
    ...
    pub fn render_second(&self, settings: &Binding, controller: &mut Controller) {
        match self {
            ...
            Trigram {
                ...
                render_yang(4, controller, &settings.cloud_colour);
                render_yin(5, controller, &settings.cloud_colour);
            }
            // Sun
            Trigram {
                top: Line::Yang,
                ...
                render_yin(4, controller, &settings.sun_colour);
                render_yang(5, controller, &settings.sun_colour);
            }
            // Wind
            Trigram {
                top: Line::Yang,
                ...
                render_yang(4, controller, &settings.wind_colour);
                render_yang(5, controller, &settings.wind_colour);
            }
            // Thunder
            Trigram {
                top: Line::Yin,
                ...
                render_yin(4, controller, &settings.thunder_colour);
                render_yin(5, controller, &settings.thunder_colour);
            }
            // Water
            Trigram {
                top: Line::Yin,
                ...
                render_yang(4, controller, &settings.water_colour);
                render_yin(5, controller, &settings.water_colour);
            }
            // Mountain
            Trigram {
                top: Line::Yang,
                ...
                render_yin(4, controller, &settings.mountain_colour);
                render_yang(5, controller, &settings.mountain_colour);
            }
            // Earth
            Trigram {
                top: Line::Yin,
                ...
                render_yin(4, controller, &settings.earth_colour);
                render_yin(5, controller, &settings.earth_colour);
            }
        }
    }
